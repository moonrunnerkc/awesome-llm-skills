...
- [TraceMantle](https://github.com/moonrunnerkc/tracemantle) - CLI and GitHub Action that validates SKILL.md frontmatter, file references, and size limits against the Agent Skills spec, and hashes skill bundles so changes to helper files are detected. Reads files only; does not execute skills. MIT licensed.
